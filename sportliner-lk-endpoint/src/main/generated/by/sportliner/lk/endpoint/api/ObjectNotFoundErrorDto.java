...
public class ObjectNotFoundErrorDto extends BaseErrorDto {

  public ObjectNotFoundErrorDto message(String message) {
    super.setMessage(message);
    return this;
  }

  public ObjectNotFoundErrorDto type(BaseErrorTypeDto type) {
    super.setType(type);
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectNotFoundErrorDto {\n");
