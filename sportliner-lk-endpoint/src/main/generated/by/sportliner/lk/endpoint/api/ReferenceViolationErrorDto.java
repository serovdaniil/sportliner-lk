...
public class ReferenceViolationErrorDto extends BaseErrorDto {

  public ReferenceViolationErrorDto message(String message) {
    super.setMessage(message);
    return this;
  }

  public ReferenceViolationErrorDto type(BaseErrorTypeDto type) {
    super.setType(type);
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ReferenceViolationErrorDto {\n");
