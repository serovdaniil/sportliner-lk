...
public enum InvoiceQueryType {
  ...
  InvoiceQueryType(Integer value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static InvoiceQueryType fromValue(Integer value) {
    for (InvoiceQueryType b : InvoiceQueryType.values()) {
