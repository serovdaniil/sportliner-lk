...
/**
 * Расписание формирования отчетов
 */
public enum PeriodicityTypeEnum {
  ...
  PeriodicityTypeEnum(Integer value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PeriodicityTypeEnum fromValue(Integer value) {
    for (PeriodicityTypeEnum b : PeriodicityTypeEnum.values()) {
