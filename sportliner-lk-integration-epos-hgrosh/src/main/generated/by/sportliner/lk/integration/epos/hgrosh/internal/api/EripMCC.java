...
/**
 * Категории мерчантов по ЕРИП
 */
@JsonPropertyOrder({
  EripMCC.JSON_PROPERTY_CODE,
  EripMCC.JSON_PROPERTY_NAME
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class EripMCC {
  ...
  public EripMCC code(String code) {
  ...
  **/
  ...
  public EripMCC name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EripMCC eripMCC = (EripMCC) o;
    return equalsNullable(this.code, eripMCC.code) &&
        equalsNullable(this.name, eripMCC.name);
  }
